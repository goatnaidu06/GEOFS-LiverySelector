...
function generateListHTML() {
    return `
        ...
        <br/>
        <a href="https://raw.githubusercontent.com/goatnaidu06/GEOFS-LiverySelector/refs/heads/main/tutorial.txt" target="_blank"><button class="mdl-button mdl-js-button mdl-button--raised mdl-button">Open tutorial</button></a><br/>
        ...
        <a href="https://github.com/goatnaidu06/GEOFS-LiverySelector" target="_blank"><button class="mdl-button mdl-js-button mdl-button--raised mdl-button">Visit our Github page</button></a><br/>
